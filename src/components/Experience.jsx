      ...
      <div className="row justify-content-center m-0">
        <div className="col-xl-12 col-lg-12 col-md-12">
          <div className="marquee">
            <h3>
              Business Websites * Lead Generation Websites * eCommerce
              Platforms * Custom WordPress Solutions * UI/UX Design *
              WordPress Development * Shopify Development * WooCommerce
              Solutions * Website Optimization & Support * Server Management *
              DNS Configuration * Website Migration * Performance Optimization
